...
| Bootstrap | `gitops/bootstrap/applications/*.yaml` | `gitops/bootstrap/root-app.yaml.example` → `root-app.yaml` |
...
| Key Vault CSI (frontend v1) | Terraform UAMI, `gitops/platform/dev/secret-provider-class-frontend.yaml` | [key-vault-csi-v1](docs/secrets/key-vault-csi-v1.md) |
...
| 2 | [Cluster bootstrap](docs/implementation/phase-02-cluster-bootstrap.md) | **Helm install** platform (ingress, cert-manager, external-dns, monitoring, Argo CD), then Argo root app |
