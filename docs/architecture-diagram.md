...
This doc gives a visual map of the architecture (three Mermaid diagrams from different angles) and a short reference for every tool in the stack with the connections between them.
