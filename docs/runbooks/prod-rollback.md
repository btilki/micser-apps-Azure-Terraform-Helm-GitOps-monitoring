...
- Error rate or latency spikes on `boutique.example.com` (and any other prod ingress hosts you use).
...
4. **Verify:**
   ...
   curl -sS -o /dev/null -w "%{http_code}" https://boutique.example.com/
   ```
