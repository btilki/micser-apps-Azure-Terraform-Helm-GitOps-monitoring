...
SMOKE_DEV_URL="${SMOKE_DEV_URL:-https://dev.boutique.biroltilki.art}"
SMOKE_STAGE_URL="${SMOKE_STAGE_URL:-https://stage.boutique.biroltilki.art}"
SMOKE_PROD_URL="${SMOKE_PROD_URL:-https://boutique.biroltilki.art}"
